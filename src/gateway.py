...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--light-on-gcode",  default="LIGHT_ON",   help="G-code for l:on")
    parser.add_argument("--light-off-gcode", default="LIGHT_OFF",  help="G-code for l:off")
    parser.add_argument(
        "--sheet-template",
        default="SET_PRINT_SHEET NAME={sheet}",
        help="Format string for s:<sheet>; supports {sheet}",
    )
    parser.add_argument(
        "--z-offset-template",
        default="SET_GCODE_OFFSET Z_ADJUST={value:.2f} MOVE=1",
